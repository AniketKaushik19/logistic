          ...
          <div className="bg-linear-to-br from-white to-blue-50 shadow-xl rounded-xl p-6 border border-blue-200 lg:w-250 lg:mx-auto">
            ...
            <div className="mb-8 bg-linear-to-br from-green-50 to-emerald-50 p-4 rounded-lg border border-green-200">
              ...
              <div className="flex gap-2 mb-4 flex-col">
                ...
                <button onClick={addExpense} className="bg-linear-to-br from-green-500 to-emerald-500 text-white px-4 py-2 rounded-lg hover:from-green-600 hover:to-emerald-600 transition-all transform hover:scale-105 shadow-md">
                  Add Expense
                </button>
                </div>
              </div>
