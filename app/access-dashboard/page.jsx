...
export default function AccessDashboard() {
  ...
  const fetchAdmins = async () => {
    try {
      ...
      const res = await fetch("/api/admin/access", {   method: "GET",
      credentials: "include",
      cache: "no-store",
  ...
  const handleCeoConfirm = async (ceo) => {
    try {
      ...
      toast.success(
        action === "edit" ? "Password updated" : "Admin deleted"
      );
      fetchAdmins();
    } catch (err) {
  ...
  <>
  <Navbar/>
    <div className="p-10 min-h-screen bg-gradient-to-br from-indigo-50 to-purple-100 mt-15 md:mt-10">
